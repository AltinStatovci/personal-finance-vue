...
//     const getAllUserBalance = async (userId) => {
//         try {
//             const response = await axios.get(`finance/balances/${userId}`,{
//                 headers: {
//                     'Authorization': `Bearer ${token}`
//                 }});
//
...
//     const calculateUserBudget = async (userId) => {
//         try {
//             const response = await axios.get(`finance/total-budget/${userId}`, {
//                 headers: {
//                     'Authorization': `Bearer ${token}`
//                 }
//
...
//     const getAllUserExpenses = async (userId) => {
//         try {
//             const response = await client.get(`finance/expenses/user/${userId}`,{
//             });
//             return response.data;
//         } catch (error) {
//             console.error('Error getting user expenses:', error);
...
//     const calculateUserExpensesByCategory = async (userId, category) => {
//         try {
//             const response = await client.get(`$finance/expenses/total-expenses/${userId}/category/${category}`,{
//             });
//             return response.data;
//         } catch (error) {
//             console.error('Error getting user category expenses:', error);
...
//     const calculateUserExpenses = async ( userId) => {
//         try {
//             const response = await client.get(`finance/expenses/total-expenses/${userId}`, {
//
//
//             });
//             return response.data;
...
//     const addBalance = async (newBalance) => {
//         try {
//             await client.post(`finance/`, newBalance,{
//             });
//         } catch (error) {
//             console.error('Error adding balance:', error);
//             throw error;
...
//     const addExpenses = async (newExpenses) => {
//         try {
//             await client.post(`finance/expenses/`, newExpenses,{
//
//             });
//         } catch (error) {
//             console.error('Error adding expenses:', error);
...
//     const updateBalance = async (id, updatedBalance) => {
//         try {
//             await client.put(`finance/${id}`, updatedBalance,{
//
//             });
//         } catch (error) {
//             console.error('Error updating balance:', error);
...
//     const updateExpenses = async (id, updatedExpenses) => {
//         try {
//             await client.put(`finance/expenses/${id}`, updatedExpenses,{
//
//             });
//         } catch (error) {
//             console.error('Error updating expenses:', error);
